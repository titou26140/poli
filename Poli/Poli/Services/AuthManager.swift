...
final class AuthManager: ObservableObject {
    ...
    struct User: Codable {
        ...
        enum CodingKeys: String, CodingKey {
            case id, name, email, tier
            case isPro = "is_pro"
            case remainingActions = "remaining_actions"
    ...
    private func syncEntitlements(from user: User) {
        ...
        let effectiveTier = storeKitTier.dailyLimit >= backendTier.dailyLimit ? storeKitTier : backendTier
        let remaining = user.remainingActions ?? effectiveTier.dailyLimit
